...
public class GraphStream extends KeyedStream<Edge<Vertex, Vertex>, String> {
    private static final long serialVersionUID = 1L;
    public HashMap<String, Edge<Vertex, Vertex>> edges;
    ...
    public transient DataStreamSource<Edge<Vertex, Vertex>> graphDataStream;
    public ControlMessage controlMessage;
    public boolean isGrouping;
    public transient Table groupedTable;


    public GraphStream(DataStream<Edge<Vertex, Vertex>> dataStream, KeySelector<Edge<Vertex, Vertex>, String> keySelector, TypeInformation<String> keyType) {
        super(dataStream, keySelector, keyType);
    }

    public GraphStream(DataStream<Edge<Vertex, Vertex>> dataStream, KeySelector<Edge<Vertex, Vertex>, String> keySelector) {
